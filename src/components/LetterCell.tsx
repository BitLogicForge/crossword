    ...
    <TableCell sx={{ p: 0, m: 0, border: 0 }}>
      <Box
        ...
        initial={{
          ...
          opacity: 0,
          backgroundColor:
            letter === SYMBOL.EMPTY ? themeOptions?.palette.primary.main : themeOptions?.palette.secondary.main,
        }}
        animate={{
          scale: [1, 0.5, 1],
          opacity: [0, 0.7, 1],
          backgroundColor:
            letter === SYMBOL.EMPTY ? themeOptions?.palette.secondary.main : themeOptions?.palette.primary.main,
        }}
        transition={{
          delay: delay,
          duration: duration,
