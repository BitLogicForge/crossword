...
export default function WidthSlider() {
  ...
  return (
    <Box sx={{ px: 2, mb: 2 }}>
      <Typography gutterBottom>Width: {localWidth}</Typography>
      <Slider
        value={localWidth}
        min={5}
        max={20}
        ...
        onChange={(_event, value) =>
          setLocalWidth(Array.isArray(value) ? value[0] : value)
        }
        onChangeCommitted={(_event, value) =>
          dispatch(setGridWidth(Array.isArray(value) ? value[0] : value))
        }
